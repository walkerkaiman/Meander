// Reusable export/import functionality for MEANDER applications
import { ProjectData, ValidationError } from '../../../Editor/src/types/index';
...
export class ExportLoader {
  ...
  static async loadExportedShow(file: File): Promise<ProjectData | null> {
    try {
      // Dynamically import JSZip from Editor's dependencies
      const JSZip = (await import('../../../Editor/node_modules/jszip')).default;
