...
func (s *Server) Routes() http.Handler {
	...
	api.HandleFunc("/show-logic/{logic_id}/copy", s.CopyShowLogicFile).Methods(http.MethodPost)
	api.HandleFunc("/show-logic/{logic_id}", s.GetShowLogicFile).Methods(http.MethodGet)
	api.HandleFunc("/show-logic/{logic_id}", s.UpdateShowLogicFile).Methods(http.MethodPut)
	api.HandleFunc("/show-logic", s.CreateShowLogicFile).Methods(http.MethodPost)
	...
	api.HandleFunc("/assets", s.ListAssets).Methods(http.MethodGet)
	api.HandleFunc("/hardware-registry", s.GetHardwareRegistry).Methods(http.MethodGet)
